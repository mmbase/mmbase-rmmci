...
public class RemoteGenerator{
    ...
    public RemoteGenerator(String targetDir,String mmciFile) throws Exception{
	    ...
	    if (name.indexOf("mmbase.bridge") != -1){
    ...
    public void generateInterface(XMLClass xmlClass){
        ...
        if (xmlClass.getImplements().indexOf("mmbase.bridge") != -1){
		try {
        ...
        while(methodsEnum.hasMoreElements()){
            ...
            if (!  xmlMethod.getName().equals("equals") && !  xmlMethod.getName().equals("hashCode") && ! xmlMethod.getName().equals("toString")){
                ...
                //create a wrapper
                if ( xmlMethod.getReturnType().getOriginalName().indexOf("mmbase.bridge") != -1){
                ...
                while(iter.hasNext()){
                    ...
                    if (parameter != null){
                        if (parameter.isArray){
                            ...
                            if (parameter.getOriginalName().indexOf("mmbase.bridge") != -1){
	...
	String impl = "";
        if (xmlClass.getImplements().indexOf("mmbase.bridge") != -1 || xmlClass.getImplements().indexOf("mmbase.storage.search") != -1) {
            try {
                XMLClass xmlc = mmci.getClass(xmlClass.getImplements());
                impl = ",Remote" + xmlc.getShortName();
            } catch (NotInMMCIException e){
