 ...
 * @version $Id: ObjectWrapperGenerator.java,v 1.1 2006-09-29 08:59:07 pierre Exp $
 */
public class ObjectWrapperGenerator extends AbstractGenerator {
    ...
    protected List<Class> getSuperClasses(Class c) {
        ...
        if (retval == null) {
            retval = new ArrayList<Class>(Arrays.asList(c.getInterfaces()));
    ...
    public void generateHeader() {
        ...
        buffer.append("import org.mmbase.bridge.remote.implementation.*;\n");
    ...
    public void generate() {
        ...
        buffer.append("  public static Object rmiObjectToRemoteImplementation(Object o) throws RemoteException {\n");
        buffer.append("    Object retval = null;\n");
        ...
        for (Class c : objectsToWrap) {
            ...
            buffer.append("      retval = new " + remoteName + "_Impl((" + remoteName + ")o);\n");
            isFirst = false;
        }
        buffer.append("    }\n    return retval;\n  }\n\n");
