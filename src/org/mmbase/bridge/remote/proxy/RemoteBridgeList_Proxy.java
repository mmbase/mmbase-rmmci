...
public class RemoteBridgeList_Proxy<L extends Comparable<? super L>,E> extends RemoteList_Proxy<L,E> implements BridgeList<L>, MappedObject  {
    ...
    public Object getProperty(Object arg0) {
        try {
            Object retval = ObjectWrapper.rmiObjectToRemoteProxy(getWrappedObject().getProperty(ObjectWrapper.remoteProxyToRMIObject(arg0)));
            return retval;
        } catch (RuntimeException e) {
            throw e ;
        } catch(Exception e) {
    ...
    public Map<Object, Object> getProperties() {
        try {
            Map<Object, Object> retval = (Map<Object, Object>) ObjectWrapper.rmiObjectToRemoteProxy(getWrappedObject().getProperties());
            return retval;
        } catch (RuntimeException e) {
            throw e ;
        } catch(Exception e) {
